	...
	<body>
		...
		<?php
			...
			if(isset($_POST['envoyer']))
			{
				...
				$contenu=trim(htmlentities(mysqli_real_escape_string($lien,$_POST['commentaire'])));
			...
			//Quelle page je suis et quels commentaires affichés
			if(!isset($_GET['page']))
			{
				$page=1;
			}
			...
			$commparpage=5;//combien de commentaire par page
			...
			//Affichages des numéros de page
